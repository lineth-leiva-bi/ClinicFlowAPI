...
function Clientes() {
  ...
  const guardarCliente = async (e) => {
    ...
    await Swal.fire({
      icon: "success",
      title: clienteEditandoId ? "Cliente actualizado" : "Cliente registrado",
  ...
  const totalPaginas = Math.ceil(clientesFiltrados.length / clientesPorPagina) || 1;
  ...
  return (
    <div className="clientes-page">
      ...
      <section className="clientes-table-card">
        <h3>Clientes registrados ({clientesFiltrados.length})</h3>
